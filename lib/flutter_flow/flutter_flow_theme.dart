...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC72C48);
  late Color secondary = const Color(0xFFF0E68C);
  late Color tertiary = const Color(0xFF4E9F3D);
  ...
  late Color accent2 = const Color(0xFFC0C0C0);
  late Color accent3 = const Color(0xFF8B0000);
  late Color accent4 = const Color(0xFF00008B);
