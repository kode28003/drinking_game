...
//   /// 日本語の質問とUIテキストを直接定義
//   final Map<String, dynamic> japaneseContent = {
//     'title': '多数決ゲーム',
...
//       // 日本語の初期メッセージを直接使用
//       _gameMessage = japaneseContent['message']['initial'];
//     });
//   }
...
//       // 'all'が選択されている場合は全てのジャンルの質問を結合
//       japaneseContent['questions'].forEach((key, value) {
//         questions.addAll(value);
//       });
//     } else {
//       // 特定のジャンルが選択されている場合はそのジャンルの質問のみを使用
//       questions = japaneseContent['questions'][_selectedGenre];
//     }
...
//       _isGameComplete = false;
//       // 日本語のメッセージを直接使用
//       _gameMessage = japaneseContent['message']['chooseAnswer'];
//     });
//   }
...
//       if (isMajorityDrinks) {
//         _gameMessage = japaneseContent['message']['majorityDrinks'];
//         _isMajorityCommand = true;
//       } else {
//         _gameMessage = japaneseContent['message']['minorityDrinks'];
...
//                         }
//                       },
//                       items: japaneseContent['genres']
//                           .keys
//                           .map<DropdownMenuItem<String>>((String value) {
//                         return DropdownMenuItem<String>(
//                           value: value,
//                           child: Text(japaneseContent['genres'][value]),
//                         );
//                       }).toList(),
//                     ),
//                   ],
...
//                   ),
//                   child: Text(
//                     japaneseContent['newQuestionButton'],
//                     style: const TextStyle(
...
//                   style: ElevatedButton.styleFrom(
//                     backgroundColor: const Color(0xFFC026D3), // fuchsia-500
//                     shape: const StadiumBorder(),
//                     padding: const EdgeInsets.symmetric(
//                         horizontal: 48, vertical: 16),
//                     elevation: 8,
//                   ),
//                   child: Text(
//                     japaneseContent['showCommandButton'],
//                     style: const TextStyle(
...
//                   ),
//                   child: Text(
//                     japaneseContent['nextQuestionButton'],
//                     style: const TextStyle(
//                         fontSize: 18.0, fontWeight: FontWeight.bold),
//                   ),
//                 ),
