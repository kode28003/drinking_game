...
class FFAppState extends ChangeNotifier {
  ...
  List<DrinkingGamesDateStruct> _drinkingGameStates = [
    ...
    DrinkingGamesDateStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"フルーツと爆弾ゲーム\",\"description\":\"\\\"1〜3までのサイコロを振って、出た目の数だけフルーツが落ちてきます。\\nただし、爆弾が落ちてきたらアウト！ \\n爆弾を引いた人は罰ゲームとしてお酒を飲みます。\\nシンプルながらハラハラ感が盛り上がるゲームです。\",\"minPlayers\":\"2\",\"recommendStar\":\"4\",\"subTitle\":\"サイコロでフルーツを集めて、爆弾が出たら飲む！\",\"isOnlyJapan\":\"false\",\"useThisApp\":\"true\",\"thisAppNav\":\"fruit\",\"titleEn\":\"Fruit & Bomb Game\",\"descriptionEn\":\"Roll a dice (1–3), and the number you roll decides how many fruits drop. \\nBut watch out — if a bomb drops, you’re out! The unlucky player must drink as a penalty.\\nA simple yet suspenseful game that keeps everyone on edge and laughing.\",\"subTitleEn\":\"Roll the dice to drop fruits — but if a bomb drops, you drink!\"}'))
  ];
